...
const Reservation = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-3xl font-bold mb-4">Welcome to reservatoon</h2>
      <p>Welcome to our luxurious hotel. Reserve now</p>
      {/* Add more detailed content and images as needed */}
    </div>
  );
};
